...
export default function Faq(props) {
    return (
        ...
        <div className="FAQ d-flex justify-content-center align-items-center" style={props.style}>
            <div className="container d-flex justify-content-center align-items-center row">
                <div className="justify-content-center align-items-center col-sm-12 col-md-4 col-lg-3" >
                    <img className="issue-img"src="https://www.cowin.gov.in/assets/images/faq_Section.svg" alt="" />
                </div>
                <div className="col-sm-12 col-md-8 col-lg-9">
                    ...
                    <div class="accordion accordion-flush my-5" id="accordionFlushExample" style={{position: 'relative', left: '5rem', overflow: 'hidden'}}>
        ...
        <Footer style={{ width: '100%', position: 'relative', top: '0rem'}}/>
        </>
    )
}
